export default function Footer() {
    ...
    return (
        <footer className="bg-gray-900 px-4 py-12 border-t border-gray-800">
                ...
                <div className="grid gap-8 md:grid-cols-3">
                    ...
                    <div>
                        ...
                        <p className="text-gray-400">
                            Software & AI Engineer specializing in AI, Cloud, and Distributed Systems.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex gap-4">
                            ...
                            <a
                                href="https://www.facebook.com/md.salman.farse.126061"
                                target="_blank"
                                rel="noopener noreferrer"
